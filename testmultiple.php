		...
		<div class="row mx-1">
				...
				<?php 
					...
					<div class="col-sm-12 col-md-6 cud">
						<h5 class="text-justify"><?php echo $value ?>:</h5>
						...
						<?php 
							...
							if ($resul_res = mysqli_query($con,$query2)) {
								while ($row_res = mysqli_fetch_assoc($resul_res)) { ?>
									<li class="respuestasli">-<?php echo $row_res["respuesta"] ?></li>
							...
							<select style="margin-bottom:1rem;" class="form-control form-control-sm">
								...
								<?php 
									...
									if ($resul_res = mysqli_query($con,$query2)) {
										...
										while ($row_res = mysqli_fetch_assoc($resul_res)) { ?>
											<option id="<?php echo $row_res["id"] ?>"><?php echo $row_res["respuesta"] ?></option>
									<?php	}
									}else{
										echo "mala consulta";
									}
